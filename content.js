  ...
  ideas: [
    {
      ...
      title: "1000億円の使い方",
      summary:
        "1000億円を1年で使い切れ、をテーマにした現実制約付きの巨大資本消費シミュレーション案。投資禁止・資産保持NGの条件下で、納期・契約・信用・法規制を考慮しながら消費プランを組み立てる。",
      year: "2026.05",
      tags: ["Simulation", "Web", "Game", "AI"],
      cta: "Read detail",
      details: [
        "投資・資産保持禁止で1000億円を1年で蒸発させる",
        "消費効率という独自指標で不可逆な消費を評価する",
        "納期・契約・信用・法規制などの現実制約をシミュレートする",
        "Web診断形式のMVPから、最終的にはSteam向けPCゲーム化も視野",
      ],
      page: {
        eyebrow: "App Idea / 2026.05",
        intro:
          "1000億円を1年で使い切れ、をテーマにした現実制約付きの消費シミュレーション。単なる金額計算ではなく、巨大資本を現実世界で消滅させることの難しさを体験させる方向で設計する。投資禁止・資産保持NGの条件下で、納期・契約・信用・供給量・法規制を加味した実行プランをAIが生成する。",
        highlights: [
          "お金を持っている≠使える、をシミュレーションで体感させる",
          "消費効率という独自指標で「どう不可逆に溶かすか」を採点する",
          "MVPはWeb診断、将来的にSteam向けPCゲーム化まで射程に入れる",
        ],
        sections: [
          {
            title: "コンセプト",
            paragraphs: [
              "テーマは「1000億円を1年で使い切れ」。",
              "ただし投資は禁止、資産移動は無効、現実世界の制約あり、契約・納期・信用・供給量・法規制ありの条件で、本当に実行可能な範囲だけで消費する必要がある。",
              "単なる金額計算ではなく、現実世界で巨大資本を消滅させる難しさを体験するシミュレーションとして設計する。",
            ],
          },
          {
            title: "コア思想",
            paragraphs: [
              "「お金を持っている」≠「使える」。",
              "巨大資産になるほど、市場に存在しない、納期が長い、信用審査が必要、法規制がある、人材確保が必要、実行期間が足りない、といった現実問題が次々と発生する。",
            ],
          },
          {
            title: "入力項目: 基本条件",
          ...
          },
          {
            title: "消費効率の概念",
            paragraphs: [
              "重要なのは「どう買うか」ではなく、「どう不可逆に消費するか」。資産として残ってしまう消費は効率が低く、その場で蒸発する消費は効率が高い。",
            ],
            bullets: [
              "高級車購入: 20%",
              "高級車を爆破: 98%",
          ...
          },
          {
            title: "現実制約システム",
            paragraphs: [
              "狂った消費を、現実世界でどう成立させるかを段階的にシミュレーションする。例として、フェラーリ5台購入を実行しようとすると次のような制約の連鎖が発生する。",
            ],
            bullets: [
              "フェラーリ5台購入",
              "新品納車1年以上 → 中古市場へ変更",
          ...
          },
          {
            title: "UI案: ガントチャート表示",
            paragraphs: [
              "巨大予算を実際に執行するプロジェクト管理感を重視し、週単位で進行を可視化する。",
            ],
            bullets: [
              "Week 1: 法務チーム契約、広告代理店選定",
              "Week 2: MV制作開始、スタッフ採用、会場予約",
              "Week 3〜5: 広告制作、イベント施工、映像撮影",
              "Week 6〜8: 大型イベント開催、展示会運営",
            ],
          },
          {
            title: "方向性",
            paragraphs: [
              "単なるバカゲーではなく、複数の側面を同時に持つプロダクトとして設計する。",
            ],
            bullets: [
              "富豪シミュレーター",
              "巨大資本オペレーション",
          ...
          },
          {
            title: "MVP",
            paragraphs: [
              "まずはWeb診断形式で、入力 → 現実制約シミュレーション → 詳細レポート生成を最短で実装する。",
              "技術構成は Next.js + Supabase + AI API を想定する。",
            ],
          },
        ],
      },
    ...
    },
    {
      ...
      summary:
        "あとで読むためではなく、将来使うかもしれない情報をあとから思い出せるようにする、自分専用ブラウザ / 記憶拡張ツール案。整理ではなく再発見を中心に置く。",
      year: "2026.04",
      status: "自分用から検証",
      tags: ["Search", "AI", "Bookmark", "Memory"],
      cta: "Read detail",
      details: [
        "URLを保存するとAIがタグ、要約、関連語、embeddingを生成",
        "雑な言葉でも検索でき、関連リンクが芋づるで出る",
        "フォルダ管理、手動タグ、未読管理、整理UIは作らない",
        "Next.js + Vercel + Supabase pgvector の最小構成を想定",
      ],
      page: {
        eyebrow: "App Idea / 2026.04",
        intro:
          "これはあとで読むツールではなく、将来使うかもしれない情報をあとから思い出せるようにするツール。ブックマーク管理でもノートでもなく、自分専用ブラウザや記憶拡張ツールに近い。",
        highlights: [
          "目的は整理ではなく再発見。曖昧な記憶から過去の情報を引き出す",
          "思い出す、広がる、確認する、の流れを最短にする",
          "保存よりも、記憶ベースで引ける状態を作ることに価値を置く",
        ],
        sections: [
          {
            title: "コンセプト",
            paragraphs: [
              "このツールの価値は、情報を綺麗に整理することではなく、あとから思い出せる状態にすること。",
              "検索を起点にして、曖昧な記憶や雑な言葉から過去の情報へ辿り着けるようにする。",
            ],
            bullets: [
              "あとで読むではなく、あとから思い出すためのツール",
              "ブックマーク管理でもノートでもない",
              "自分専用ブラウザ / 記憶拡張ツールに近い",
            ],
          },
          {
            title: "コア体験",
            bullets: [
              "URLを保存する: X投稿、Webページなど",
              "サーバーでAIが意味付けする: タグ、要約、関連語",
              "検索すると雑な言葉でもヒットする",
              "1件見つけると関連が芋づるで出る",
              "そのまま内容を確認し、元リンクを開く",
              "思い出す → 広がる → 確認する、の流れを最短にする",
          ...
          },
          {
            title: "検索ロジック",
            paragraphs: [
              "全文検索によるキーワード一致と、ベクトル検索による意味一致を組み合わせる。",
              "検索結果を統合して表示し、類似 embedding から関連リンクも出す。",
            ],
          },
          {
            title: "保存導線",
            paragraphs: [
              "初期はWeb画面からURLを貼り付ける。拡張として、Chrome拡張で見ているページを1アクションで送れるようにする。",
              "最重要は、保存が面倒で使わなくなる問題を潰すこと。",
            ],
          },
          {
            title: "インポート機能",
            bullets: [
              "ブラウザブックマーク HTML の取り込み",
              "Xブックマーク取り込み: エクスポート前提",
              "いいね取り込みはオプション。ノイズが多いため優先度は低い",
            ],
          },
          {
            title: "コスト設計",
            bullets: [
              "AIコストは保存時のみ発生",
              "検索はほぼ無料",
              "軽量モデル使用で1件あたり数円レベルに抑える",
              "初期インポートは段階処理でコスト爆発を防ぐ",
              "月500円前後で成立可能な構成を目指す",
            ],
          },
          {
            title: "類似サービス ブックマーク管理系",
            paragraphs: [
              "既存のブックマーク・知識管理系サービスはいくつか存在するが、それぞれ思想が異なる。",
              "Raindrop.io、Linkwarden、start.me などは、整理・分類・一覧性を中心にした保存寄りのツールとして参考になる。",
            ],
            bullets: [
              "Raindrop.io: クラウド型の代表的なブックマーク管理ツール。タグ、フォルダ、コレクション、マルチデバイス同期が中心",
              "Linkwarden: セルフホスト可能なブックマーク管理ツール。保存、タグ、スクショやPDFアーカイブなど長期保存に強い",
              "start.me: スタートページ型のブックマーク管理。ウィジェットやRSSで情報を並べる思想が強い",
              "共通点: 整理・分類・一覧性が中心",
              "違い: 検索や再発見より、管理に寄っている",
            ],
          },
          {
            title: "類似サービス Read It Later系",
            paragraphs: [
              "wallabag のような Read It Later 系は、記事をあとで読みやすく保存・閲覧する体験に強い。",
            ],
            bullets: [
              "wallabag: 記事を読みやすく保存・閲覧するためのツール。オフラインや読書体験に強い",
              "共通点: あとで読む前提",
              "違い: 検索や再利用より、消費が目的",
            ],
          },
          {
            title: "類似サービス AIブックマーク系",
            paragraphs: [
              "AIブックマーク系は、保存した情報の整理・検索・要約をAIで強化する最近の流れとして参考になる。",
            ],
            bullets: [
              "LinkList: AIで自動タグ付け、要約、チャット検索ができるブックマークツール",
              "MyMind: 視覚的に整理しつつ、AIで自動分類するミニマル志向のツール",
              "Fabric: リンク、画像、メモなどを横断的に保存し、AIで扱う知識管理ツール",
              "共通点: AIで整理・検索を強化",
              "違い: チャットUIやノート寄りの設計が多い",
            ],
          },
          {
            title: "類似サービス 自己ホスト系",
            paragraphs: [
              "自己ホスト・パワーユーザー系は、データ所有や自由度の面で参考になる。",
            ],
            bullets: [
              "Karakeep: AIタグ付けや全文検索を備えた自己ホスト型ツール。プライバシー重視",
              "Floccus: ブラウザ間でブックマークを同期するツール。保存ではなく同期に特化",
              "共通点: データ所有・自由度重視",
              "違い: 一般ユーザーにはやや重い",
            ],
          },
          {
            title: "このプロダクトとの違い",
            paragraphs: [
              "既存ツールは、整理する、読む、管理する、AIでまとめる、のどれかに寄っている。",
              "一方で、このプロダクトは思い出すことに特化する。",
            ],
            bullets: [
              "フォルダや整理を前提にしない",
              "保存ではなく検索が主役",
          ...
          },
          {
            title: "ポジショニング",
            paragraphs: [
              "既存ツールが保存、整理、ノートに寄っているのに対し、このツールは検索、再発見、思い出しに特化する。",
              "保存ではなく、思い出すことを中心に置く。",
            ],
            bullets: [
              "Raindrop / Linkwarden: 整理ツール",
              "wallabag: 消費ツール",
              "AI系ツール: 知識整理・チャット",
              "このプロダクト: 記憶検索ツール、自分専用ブラウザ",
            ],
          },
          {
            title: "開発方針",
          ...
          },
          {
            title: "本質",
            paragraphs: [
              "過去に見た情報を、記憶ベースで引ける状態にする。",
              "単なる便利ツールではなく、自分の思考履歴を引き出す装置として設計する。",
            ],
          },
        ],
      },
  ...
  timeline: [
    {
      ...
      summary:
        "投資禁止・資産保持NGの条件下で巨大資本を1年で消費する、現実制約付きの消費シミュレーション案を記録。Web診断MVPから将来的にSteamゲーム化までを見据える。",
    },
    {
      date: "2026.04",
    ...
    },
    {
      ...
      summary:
        "Raindrop、Linkwarden、wallabag、AIブックマーク系、自己ホスト系との違いを整理し、記憶検索ツールとしての立ち位置を補強。",
    },
    {
      date: "2026.04",
      title: "Memory Recall Browser のアイデアを追加",
      summary:
        "保存したURLをAIで意味付けし、曖昧な記憶から過去の情報を再発見する自分専用ブラウザ案を記録。",
    },
    {
      date: "2026.04",
